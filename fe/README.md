...
Minimal React app for sending an ingredient photo to the local FastAPI model, editing the detected ingredients, and choosing between three generated recipe options.
